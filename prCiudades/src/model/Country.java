...
@NamedQuery (name="contrysByContinent" , query="SELECT c.localName FROM Country c WHERE c.continent = :cont"),
@NamedQuery(name="diferencia", query ="SELECT  c FROM Country c GROUP BY c.population")
})
